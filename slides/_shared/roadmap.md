<!--
Shared Act-0 slot-2 roadmap graphic. Paste this whole <div> block into each
deck's "Where We Are" slide, then:
  - add class="now" to the current module's .wk div
  - remove class="now" from the previous module's .wk div
Grid is 5 columns x 3 rows (15 weeks). CSS lives in themes/hankyong.css.
-->
